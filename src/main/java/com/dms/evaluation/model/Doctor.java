...
public class Doctor {
	...
	public String toString() {
		return "Doctor [appointmentNumber=" + appointmentNumber + ", doctorName=" + doctorName + ", department="
				+ department + ", appointmentDate=" + appointmentDate + ", appointmentTime=" + appointmentTime
